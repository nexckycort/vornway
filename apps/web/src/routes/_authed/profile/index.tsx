...
function RouteComponent() {
  ...
  const userName = isGuest ? user.name : 'Vianys Fontalvo';
  ...
  return (
    <GradientLayout className="pb-20">
      <div className="min-h-screen">
        ...
        {isGuest && (
          <div className="px-6">
            ...
            <div className="space-y-3 mb-8">
              <button className="w-full flex items-center justify-center gap-3 py-4 border border-gray-200 rounded-xl bg-white">
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
                  fill="currentColor"
            ...
            >
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  {isGuest ? user.name : 'Vianys Fontalvo'}
                </p>
              </div>
              ...
              <>
                ...
                <button className="w-full flex items-center justify-between p-4 text-left">
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">vianys24@gmail.com</p>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-400" />
                </button>
              </>
        ...
        {/* Support Section (only for logged in users) */}
        {!isGuest && (
